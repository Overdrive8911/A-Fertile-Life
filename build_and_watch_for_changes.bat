...
if exist src/js/dist/variable_initialization set arg7=src/js/dist/variable_initialization
if exist src/js/dist/date_and_time set arg8=src/js/dist/date_and_time
if exist src/js/dist/location set arg9=src/js/dist/location
if exist src/js/dist/ui set arg10=src/js/dist/ui

if exist src/js/extensions set arg11=src/js/extensions
if exist src/css/extensions set arg12=src/css/extensions

if exist src/passages set arg13=src/passages

if exist src/variables set arg14=src/variables
