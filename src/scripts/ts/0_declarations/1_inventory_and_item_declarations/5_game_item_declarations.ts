namespace NSInventoryAndItem {
  ...
  export const gInGameItems: { [key in ItemId]?: Item } = {
    ...
    [ItemId.FOOD_MOULDY_CHEESE]: new Item({
    ...
    [ItemId.KEY_CARD_LVL_1]: new Item({
    ...
    [ItemId.KEY_CARD_LVL_2]: new Item({
    ...
    [ItemId.KEY_CARD_LVL_3]: new Item({
    ...
    [ItemId.KEY_CARD_LVL_4]: new Item({
    ...
    [ItemId.KEY_CARD_LVL_5]: new Item({
