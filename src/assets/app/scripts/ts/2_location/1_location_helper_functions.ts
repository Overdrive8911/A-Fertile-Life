import {
  MapLocation,
  MapSubLocation,
} from '../0_declarations/1_location_declarations/0_enums'
import type { LocationCoords } from '../0_declarations/1_location_declarations/0_types_and_interfaces'
import { distanceToMetresConversionRange } from '../0_declarations/1_location_declarations/variables/0_other_data'
import { gLocationData } from '../0_declarations/1_location_declarations/variables/9_general_location_data'
...
export function getLocationFromPassageTitle(passageTitle: string) {
...
export function getSubLocationFromPassageTitle(passageTitle: string) {
  const passageTags = tags(passageTitle)
...
export function getLocationFromMapLocationId(input: MapLocation) {
...
export function getSubLocationFromMapSubLocationId(input: MapSubLocation) {
...
export function getMapLocationIdFromLocation(input: string): MapLocation {
...
export function getMapSubLocationIdFromSubLocation(
  input: string
): MapSubLocation {
...
export function getDefaultNameOfSubLocation(
