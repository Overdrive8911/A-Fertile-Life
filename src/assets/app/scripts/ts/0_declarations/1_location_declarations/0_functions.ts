import { LocationCoordIndex, MapLocation, MapSubLocation } from './0_enums'
import type { LocationCoords } from './0_types_and_interfaces'
import { gLocationData } from './variables/9_general_location_data'
...
export function getCoordsRelativeToOtherSubLocation(
  ...
  const otherSubLocationCoords = getSubLocationCoords(locationId, subLocationId)
