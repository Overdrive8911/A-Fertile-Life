...
import { GlobalMap, SubLocation, Location } from '../0_classes'
import {
  GlobalMapId,
  SubLocationId,
  Direction,
...
import { getCoordsRelativeToOtherSubLocation } from '../0_functions'
import type { LocationObject, LocationCoords } from '../0_types_and_interfaces'
import { gRelatedLocations } from './1_related_location_data'
...
export namespace MapArea {
  ...
  const fertiloIncLabFloor1 = new SubLocation(SubLocationId.LAB, 'Laboratory')
