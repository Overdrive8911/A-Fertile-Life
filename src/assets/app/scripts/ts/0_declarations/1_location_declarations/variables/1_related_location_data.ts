import { MapLocationContainer, MapLocation } from '../0_enums'
import type { RelatedMapLocations } from '../0_types_and_interfaces'
import { gLeftShiftValue } from './0_other_data'
