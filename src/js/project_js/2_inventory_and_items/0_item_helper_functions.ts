namespace NSInventoryAndItem {
  export const storeItem = (itemId: ItemId) => {
  ...
  export const removeItem = (itemId: ItemId, amount?: number) => {
  ...
  export const validateItemId = (itemId: ItemId) => {
  ...
  export const returnNoDuplicateArrayOfInventoryIds = () => {
    let arr: ItemId[] = [];
  ...
  export const getNumberOfItemDuplicates = (itemId: ItemId) => {
    let arr: number[] = [];
  ...
  export const doesItemHaveTag = (itemId: ItemId, tag: ItemTag) => {
