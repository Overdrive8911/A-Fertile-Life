namespace NSPregnancy {
  export const generateFetusId = (womb: Womb) => {
  ...
  export const generateFetus = (id: number) => {
  ...
  export const isPregnant = (womb: Womb) => {
  ...
  export const getPregnancyLengthModifier = (fetus: FetusData, womb: Womb) => {
  ...
  export const getTotalGestationDuration = (fetus: FetusData, womb?: Womb) => {
    return getPregnancyLengthModifier(fetus, womb) * gDefaultPregnancyLength;
  };

  export const getGestationalWeek = (
    fetus: FetusData,
    womb: Womb
  ): GestationalWeek => {
    return Math.floor(
  ...
  export const getStatForGestationalWeekInOverduePregnancy = (
  ...
  export const getAccurateFetalStatForDevelopmentStage = (
  ...
  export const getStatToAddAfterDevelopmentProgress = (
  ...
  export const getTotalOfFetalStats = (
    womb: Womb,
    stat: FetalGrowthStatsEnum
  ) => {
  ...
  export const getMinimumNumOfFullTermFetusesAtBellyState = (
    bellyState: BellyState
  ) => {
  ...
  export const calculateWombDamage = (womb: Womb) => {
  ...
  export const gradualWombHealthIncreaser = (womb: Womb) => {
  ...
  export const getWombLvl = (womb: Womb) => {
  ...
  export const getWombExpLimit = (lvl: number) => {
