...
export const PassagePrologueHomeEvent = {
		...
		return (
			<>
				<p>
					...
					staring at the ceiling. It's 9:00PM and the chilly nighttime wind
					blows into your room, although it does nothing to cool the tense air
					around you. The past few weeks have been really hectic. Ever since the
					...
					that have been coming over to your workplace to meet your boss,
					leaving him looking shaken each time they left. Not even up to a week
					later, sales started dropping steadily, which just worsened the
					situation.
				</p>

				<p>
					In fact, just two days ago at work, you were laid off. When you asked
					why, your boss shifted uncomfortably in his seat, avoiding eye
					contact, and said something about the legalities concerning your
					immigration. You're not convinced though, however you can't really
					blame him. He did give you a stable, albeit boring job that paid for
					your expenses when others rejected you. Those suspicious people most
					likely said or did something to him. Or not, maybe you're just
					overthinking this.{" "}
				...
				<p>
					Trying not to think about that, you shift your attention to an
					envelope you're holding. It was delivered by an unknown sender the
					same day you lost your job. Partially due to stress and suspicion—from
					how <em>coincidentally</em> it arrived—you didn't open it. Till now,
					that is…
				</p>

				<p>
					You rise to a sitting position and bring the envelope to your face.
					It's whitish and looks rather plain. Nothing about it feels
					suspicious, so you open it and pull out a folded paper.
				</p>
				...
				<p>
					...
					you grumble. Period pain. You chalked it up to period pain and so
					bought some medication last night, but it doesn't feel too helpful
					now.
				</p>

				<p>
					The discomfort eventually subsides in a few minutes; luckily, this
					happens seldom. Taking in another deep breath, you focus on the
				...
				<Show when={hasOpenedLetter()}>
					<p>
						...
						<span class="text-secondary">
							<em>
								"What the FUCK?! How did this guy know this? How could anyone
								know this much about me? Are they spying on me now?"
							</em>
						</span>{" "}
					...
					<p>
						<em class="text-secondary">
							"…I hate to admit it, but they're right, I don't really have much
							of a choice now. I honestly didn't have a solid plan before… If I
							go there tomorrow, even if it's a scam, I'll have a shot at
							finding out how they got to know this much… God, I hope I'll be
						...
						<PassageLink
							...
							onClick={(_) =>
								GAME_ENGINE.setVars((state) => {
									state.gameDateAndTime.skipToNextDayWithSpecificTime(7, 0);
								})
							}
						>
							sleep.
...
export const PassagePrologueHomeEventBathroom = {
	name: PassagePrologueName.PROLOGUE_WAKE_UP_AND_BRUSH_TEETH,
	passage() {
		return (
			<>
				<p>
					The digital alarm clock rings out loudly, waking you up. It is 7:00
					AM.
				</p>
				...
				<p>
					...
					<em class="text-secondary">
						"Ugh, please tell me this isn't one of the symptoms the letter
						hinted at…"
					</em>
				</p>
				<p>
					In your bathroom, you stand in front of the mirror situated right
					above the sink and see a pair of baggy eyes staring back. You're still
					wearing your clothes from yesterday; a well-worn plain baggy black
					shirt with a pair of comfy shorts, but you never cared much about
					clothing as long as it's comfortable.
				</p>
				<p>
					...
					<em class="text-secondary">
						...
						<PassageLink
							passage={PassagePrologueName.PROLOGUE_DRESSED_AND_ENTERING_BUS}
							onClick={(_) =>
								GAME_ENGINE.setVars((state) => {
									// Skip by 10 minutes
									state.gameDateAndTime.update(1000 * 60 * 10);
								})
							}
						>
							later.
