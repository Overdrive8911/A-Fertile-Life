...
const enum CupSize {
	...
	ZERO,
	/** From 299 to ZERO is AA-cup (or is it FLAT?) */
	AA = 299,
	/** From 399 to 300 (AA-cup + 1) is an A-cup */
	A = 399,
	/** From 499 to 400 (A-cup + 1) is a B-cup */
	B = 499,
	/** From 649 to 500 (B-cup + 1) is a C-cup */
	C = 649,
